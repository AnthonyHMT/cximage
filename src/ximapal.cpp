...
void CxImage::SetPalette(RGBQUAD* pPal,uint32_t nColors)
{
	...
	memcpy(GetPalette(),pPal,std::min(GetPaletteSize(),nColors*(uint32_t)sizeof(RGBQUAD)));
	info.last_c_isvalid = false;
}
////////////////////////////////////////////////////////////////////////////////
/**
...
void CxImage::SetClrImportant(uint32_t ncolors)
{
	...
	case 1:
		head.biClrImportant = std::min(ncolors,2U);
		break;
	case 4:
		head.biClrImportant = std::min(ncolors,16U);
		break;
	case 8:
